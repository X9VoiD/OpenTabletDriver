...
public partial class BindingSettingViewModel : ViewModelBase
{
    ...
    public List<PluginSettingViewModel> Settings { get; } = new();

    public BindingSettingViewModel(string bindableName, List<PluginDto> usableBindings)
    {
